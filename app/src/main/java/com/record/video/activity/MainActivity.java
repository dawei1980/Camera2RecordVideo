package com.record.video.activity;
...
import com.record.video.utils.SDFileEstablish;
import com.record.video.view.AutoFitTextureView;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < VIDEO_PERMISSIONS.length; i++) {
            if (ContextCompat.checkSelfPermission(MainActivity.this, VIDEO_PERMISSIONS[i]) != PackageManager.PERMISSION_GRANTED) {
                mPermissionList.add(VIDEO_PERMISSIONS[i]);
            }
        }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),R.string.camera_error,Toast.LENGTH_SHORT).show();
        } catch (InterruptedException e) {
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = SDFileEstablish.getsdFileEstablish().file2(false).getAbsolutePath();
        }
        ...
        mMediaRecorder.setMaxDuration(60 * 1000);  //设置记录会话的最大持续时间（毫秒）
        int rotation = getWindowManager().getDefaultDisplay().getRotation();
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(getApplicationContext(), "Video saved: " + mNextVideoAbsolutePath, Toast.LENGTH_SHORT).show();
